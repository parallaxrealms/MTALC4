...
namespace Abiogenesis3d
{
    public enum GraphicsFormatSubset
    {
        ...
        R8G8B8A8_SNorm = GraphicsFormat.R8G8B8A8_SNorm,
        R16G16B16A16_SNorm = GraphicsFormat.R16G16B16A16_SNorm,
    }
    ...
    public class UPixelator : MonoBehaviour
    {
        ...
        void HandleCamInfos()
        {
            foreach (var camInfo in cameraInfos)
            {
                ...
                {
                    Debug.LogWarning("Cameras should not have orthographicSize 0, setting to 1.");
...
// #endif
        ...
        void EnsureRenderTexture(UPixelatorCameraInfo camInfo)
        {
            ...
            camInfo.renderTexture = new RenderTexture(renderTextureSize.x, renderTextureSize.y, 0, GetGraphicsFormatFromSubset(graphicsFormat));
