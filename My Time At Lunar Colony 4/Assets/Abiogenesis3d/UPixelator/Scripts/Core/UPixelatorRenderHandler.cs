    ...
    public class UPixelatorRenderHandler : MonoBehaviour
    {
        ...
        internal void HandleFreeAspect()
        {
            ...
            if (uPixelator.renderTextureSize.y % 2 == 1)
            {
                ...
                camInfo.cam.orthographicSize -= camInfo.cam.orthographicSize / uPixelator.renderTextureSize.y;
            }
        ...
        void PreRender(Camera camera)
        {
            ...
            if (camera == uPixelator.uPixelatorCam) return;
